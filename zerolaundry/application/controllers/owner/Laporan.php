...
class Laporan extends CI_Controller{
    ...
    public function index()
    {
        ...
        if($total_rows > 0)
        {
            ...
            $config['base_url'] = base_url() . 'owner/transaksi/index';
        ...
        $this->load->view('owner/transaksi/transaksi',$data);
    ...
    // kondisi data yang akan di ambil dari database
        ...
        $this->load->view('owner/template/header',$data);
        $this->load->view('owner/transaksi/detail_transaksi',$data);
        $this->load->view('owner/template/footer');
    }
    ...
    public function dt_aksi()
    {
        ...
        if($this->form_validation->run() != false){
            ...
            // halaman di arahkan ke halaman owner transaksi
            redirect(base_url().'owner/laporan');
    ...
    public function pdf_transaksi()
    {
        ...
        $html = $this->load->view('owner/laporan/transaksi',$data, true);
    ...
    public function laporan_filter()
	{
        ...
        $this->load->view('owner/template/header',$data);
        $this->load->view('owner/transaksi/laporan',$data);
        $this->load->view('owner/template/footer');
	}
	...
	function print() {	
		...
		$this->load->view('owner/transaksi/print', $data);
	}
    ...
    function cetak_pdf() {
        ...
        $orientation = "portrait";
        $data['transaksi']=$this->m_data->data_dashboard();
        $html = $this->load->view('owner/transaksi/pdf',$data, true);
    ...
    function print_nota() {	
		...
		$this->load->view('owner/transaksi/nota_transaksi', $data);
	}
    // End Main
}