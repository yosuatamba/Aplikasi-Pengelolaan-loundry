...
class Transaksi extends CI_Controller{
    ...
    public function index()
    {
        ...
        if($total_rows > 0)
        {
            ...
            $config['base_url'] = base_url() . 'kasir/transaksi/index';
        ...
        $this->load->view('kasir/transaksi/transaksi',$data);
    ...
    // kondisi data yang akan di ambil dari database
        ...
        $this->load->view('kasir/template/header',$data);
        $this->load->view('kasir/transaksi/detail_transaksi',$data);
        $this->load->view('kasir/template/footer');
    }
    ...
    public function pdf_transaksi()
    {
        ...
        $html = $this->load->view('kasir/laporan/transaksi',$data, true);
    ...
    public function laporan_filter()
	{
        ...
        $this->load->view('kasir/template/header',$data);
        $this->load->view('kasir/transaksi/laporan',$data);
        $this->load->view('kasir/template/footer');
	}
    ...
    function cetak_pdf() {
        ...
        $orientation = "portrait";
        $data['transaksi']=$this->m_data->data_dashboard();
        $html = $this->load->view('kasir/transaksi/pdf',$data, true);
    ...
    function print_nota() {	
		...
		$this->load->view('kasir/transaksi/nota_transaksi', $data);
	}
    // End Main
}