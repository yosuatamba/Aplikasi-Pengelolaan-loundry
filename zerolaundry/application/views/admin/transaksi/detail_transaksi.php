<!-- Main -->
<a class="btn btn-primary" href="<?= base_url().'admin/transaksi' ?>" role="button">kembali</a><br><br>
<div class="card">
    ...
    <div class="card-content">
        ...
        <div class="row">
            <div class="col s115">
                <div class="card-content">
                    <form method="post" action="<?= base_url('admin/transaksi/dt_aksi') ?>" enctype="multipart/form-data">
                    ...
                    <a target="blank" href="<?php echo base_url().'admin/transaksi/print_nota/'.$row->id?>" class="btn btn-sm btn-primary"> Cetak Nota</a>
                    </form>
                </div>
            </div>
        </div>
