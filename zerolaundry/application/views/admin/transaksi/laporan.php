                                ...
                                <div class="col s12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col s6">
                                            ...
                                            <a target="blank" href="<?php echo base_url().'admin/transaksi/print/'.set_value('dari').'/'.set_value('sampai') ?>" class="btn btn-warning btn-sm"> Buat Nota</a>
                                            <a target="blank" href="<?php echo base_url().'admin/transaksi/cetak_pdf/'.set_value('dari').'/'.set_value('sampai') ?>" class="btn btn-danger btn-sm" >Buat PDF</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
