        ...
        <div id="wrapper">
            <nav class="navbar navbar-default top-navbar" role="navigation">
                ...
                <ul class="nav navbar-top-links navbar-right d-flex me-3"> 
                    ...
                    <li><a href="<?= base_url('admin/keluar'); ?>"><i class="fas fa-power-off"></i><b>Logout</b></a>
                </ul>
            </nav>
            <!--/. NAV TOP  -->
            <nav class="navbar-default navbar-side" role="navigation">
                <div class="sidebar-collapse">
                    <ul class="nav" id="main-menu">
                        <li>
                            <a class="active-menu waves-effect waves-dark" href="<?= base_url('admin/dashboard'); ?>">
                                <i class="fa fa-dashboard"></i> Dashboard
                            </a>
                        </li>
                        <li>
                            <a href="<?= base_url('admin/registrasi'); ?>" class="waves-effect waves-dark active-menu">
                            <i class="fas fa-user-plus"></i> Registrasi
                            </a>
                        </li>
                        <li>
                            <a href="<?= base_url('admin/pelanggan'); ?>" class="waves-effect waves-dark active-menu">
                                <i class="fas fa-users"></i></i> Pelanggan
                            </a>
                        </li>
                        <li>
                            <a href="<?= base_url('admin/pengguna'); ?>" class="waves-effect waves-dark active-menu">
                            <i class="fas fa-user-cog"></i> Pengguna
                            </a>
                        </li>
                        
                        <li>
                            <a href="<?= base_url('admin/paket_cucian'); ?>" class="waves-effect waves-dark active-menu">
                                <i class="fa fa-box-open"></i> Paket Cucian
                            </a>
                        </li>
                        <li>
                            <a href="<?= base_url('admin/transaksi'); ?>" class="waves-effect waves-dark active-menu">
                                <i class="fas fa-money-bill-wave"></i> Transaksi
                            </a>
                        </li>
                        <li>
                            <a href="<?= base_url('admin/outlet'); ?>" class="waves-effect waves-dark active-menu">
