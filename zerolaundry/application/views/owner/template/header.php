        ...
        <div id="wrapper">
            <nav class="navbar navbar-default top-navbar" role="navigation">
                ...
                <ul class="nav navbar-top-links navbar-right d-flex me-3"> 
                    ...
                    <li><a href="<?= base_url('owner/keluar'); ?>"><i class="fas fa-power-off"></i><b>Logout</b></a>
                </ul>
            </nav>
            <!--/. NAV TOP  -->
            <nav class="navbar-default navbar-side" role="navigation">
                <div class="sidebar-collapse">
                    <ul class="nav" id="main-menu">
                        <li>
                            <a class="active-menu waves-effect waves-dark" href="<?= base_url('owner/dashboard'); ?>">
                                <i class="fa fa-dashboard"></i> Dashboard
                            </a>
                        </li>
                        <li>
                            <a href="<?= base_url('owner/Laporan'); ?>" class="waves-effect waves-dark active-menu">
                                <i class="fas fa-money-bill-wave"></i> Laporan
                            </a>
                        </li>
                    </ul>
                </div>
